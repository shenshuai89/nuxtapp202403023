<template>
  <div>
    <div class="page">
      ...
      <!-- Breadcrumbs -->
      <section
        class="breadcrumbs-custom bg-image context-dark bg-overlay"
        style="background-image: url(/assets/images/breadcrumbs-image-1.jpg)"
      >
        <div class="breadcrumbs-custom-inner">
          <div class="breadcrumbs-custom-container container">
            <div class="breadcrumbs-custom-main">
              <h6 class="breadcrumbs-custom-subtitle title-decorated">Pages</h6>
              <h1 class="breadcrumbs-custom-title">Accordions</h1>
            </div>
      ...
      <section class="section section-lg">
        <div class="container">
          <h6>Accordion & skill bars</h6>
          <div class="row row-50 justify-content-lg-between offset-top-1">
            <div class="col-lg-7 col-xl-6">
              <h3 class="wow-outer"
                ><span class="wow slideInDown">Frequently Asked Questions</span></h3
              >
              <!-- Bootstrap collapse-->
              <div
                class="card-group-custom card-group-corporate wow-outer"
                id="accordion1"
                role="tablist"
              ...
              >
                <!-- Bootstrap card-->
                <article
                  class="card card-custom card-corporate wow fadeInDown"
                  data-wow-delay=".05s"
                >
                  ...
                  >
                    <div class="card-body">
                      <p
                        >The major advantage is price: You get a high quality design for just
                        $20-$70. You don’t have to hire a web designer or web design studio. Second
                        advantage is time frame: It usually takes 5-15 days for a good designer to
                        produce a web page of such quality.</p
                      >
                    </div>
                  </div>
                </article>
                  ...
                  <div class="card-header" id="accordion1-heading-2" role="tab">
                    <div class="card-title"
                      ><a
                        ...
                        aria-expanded="false"
                        >Do you provide any scripts with your templates or could you do some custom
                        programming? <div class="card-arrow"></div></a
                    ></div>
                  </div>
                  <div
                    class="collapse"
                  ...
                  >
                    <div class="card-body">
                      <p
                        ...
                        Flash products) are inactive. Basic scripts can be easily added at Templates
                        If you are not sure that the element you’re interested in is active please
                        contact our Support Chat for clarification.</p
                      >
                    </div>
                  </div>
                </article>
                ...
                >
                  <div class="card-header" id="accordion1-heading-3" role="tab">
                    <div class="card-title"
                      ><a
                        ...
                        aria-expanded="false"
                        >What do I receive when I order a template from Site?
                        <div class="card-arrow"></div></a
                    ></div>
                  </div>
                  <div
                  ...
                  >
                    <div class="card-body">
                      <p
                        >After you complete the payment via our secure form you will receive the
                ...
                >
                  ...
                  >
                    <div class="card-body">
                      <p
                        >Website templates are available in Photoshop and HTML formats. Fonts are
                        included with the Photoshop file. In most templates, HTML is compatible with
                        Adobe® Dreamweaver® and Microsoft® FrontPage®.</p
                      >
                    </div>
                  </div>
                </article>
            ...
            <div class="col-lg-5">
              <h3 class="wow-outer"><span class="wow slideInDown">Skill Bars</span></h3>
              <div class="progress-linear-outer wow-outer">
                <!--Linear progress bar-->
                <div
                  class="progress-linear wow slideInDown"
                  data-duration="1500"
                  data-wow-delay=".05s"
                >
                  <div class="progress-linear-header">
                    <p class="progress-linear-title">Dedication</p
                    ><span class="progress-linear-counter">90</span>
                  </div>
              ...
              <div class="progress-linear-outer wow-outer">
                ...
                >
                  <div class="progress-linear-header">
                    <p class="progress-linear-title">Knowledge</p
                    ><span class="progress-linear-counter">65</span>
                  </div>
                  <div class="progress-linear-body">
                    <div class="progress-linear-bar"></div>
                  </div>
              ...
              <div class="progress-linear-outer wow-outer">
                ...
                >
                  <div class="progress-linear-header">
                    <p class="progress-linear-title">Professionalism</p
                    ><span class="progress-linear-counter">100</span>
                  </div>
                  <div class="progress-linear-body">
                    <div class="progress-linear-bar"></div>
                  </div>
              ...
              <div class="progress-linear-outer wow-outer">
                ...
                >
                  <div class="progress-linear-header">
                    <p class="progress-linear-title">Experience</p
            ...
            <div class="col-lg-7 col-xl-6">
              ...
              >
                ...
                >
                  <div class="card-header" id="accordion2-heading-2" role="tab">
                    <div class="card-title"
                      ><a
                        ...
                        data-bs-toggle="collapse"
                        data-parent="#accordion2"
                        href="#accordion2-collapse-2"
                        aria-controls="accordion2-collapse-2"
                        aria-expanded="false"
                        >Do you provide any scripts with your templates or could you do some custom
                        programming? <div class="card-arrow"></div></a
                    ></div>
                  ...
                  <div
                    class="collapse"
                    id="accordion2-collapse-2"
                    role="tabpanel"
                    aria-labelledby="accordion2-heading-2"
                  >
                    <div class="card-body">
                      <p
                        >Our templates do not include any additional scripts. Newsletter
